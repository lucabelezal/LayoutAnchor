...
The LayoutAnchor maintainers takes security seriously.
...
See [CODE_OF_CONDUCT.md](https://github.com/viniciusfranca/LayoutAnchor/blob/master/CODE_OF_CONDUCT.md) for details.
